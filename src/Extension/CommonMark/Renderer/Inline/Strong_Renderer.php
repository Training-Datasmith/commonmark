...
final class Strong_Renderer implements Node_Renderer_Interface, Xml_Node_Renderer_Interface
{
    /**
     * @param Strong $node
     *
    ...
    {
        Strong::assert_instance_of($node);
        $attrs = $node->data->get('attributes');
        return new Html_Element('strong', $attrs, $child_renderer->render_nodes($node->children()));
    }
