...
final class Indented_Code_Renderer implements Node_Renderer_Interface, Xml_Node_Renderer_Interface
{
    /**
    ...
    {
        Indented_Code::assert_instance_of($node);
        $attrs = $node->data->get('attributes');
        return new Html_Element('pre', [], new Html_Element('code', $attrs, Xml::escape($node->get_literal())));
    }
